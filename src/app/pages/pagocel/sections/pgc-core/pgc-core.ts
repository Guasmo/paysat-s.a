...
@Component({
  selector: 'app-pgc-core',
  imports: [],
  templateUrl: './pgc-core.html',
  styleUrl: './pgc-core.css',
})
export class PgcCore implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    this.ctx = gsap.context(() => {
      ...
      const feats = section.querySelectorAll('.pgc-core-item');
